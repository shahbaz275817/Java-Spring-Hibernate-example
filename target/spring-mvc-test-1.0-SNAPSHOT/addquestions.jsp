...
<%-- 
    ...
    Created on : 12 May, 2017, 5:44:45 PM
    Author     : Shahbaz
--%>
      ...
      <form name="Questionform" id="question" method="post" action="addquestion" >
              ...
              <div class="row header">
                <div class="input-field col s12 navbar-collapse" align="center">
                  <h2 style="font-weight: bolder;">Add a new question</h2>
...
<!--              <div class="row">
                <div class="dynamiclabel form-group">
                  <input type="number" id="qid" name="qid" title="Two or more characters" class="form-control" data-error="#e1" required autofocus="" placeholder="Enter Quesion id...">
              ...
              <div class="row">
                <div class="dynamiclabel form-group">
                  <textarea id="question" name="question" class="form-control" data-error="#e2" required autofocus="" placeholder="Enter The Question..."></textarea>
