...
<html>
    ...
    <body>
        ...
        <div class="container-fluid outer">
            ...
            <h1><center>You need to sign in as site administrator to view this page</center></h1>
		...
		<form class="form-horizontal" action="login" method="post">
                    ...
                    <center><input id="submit" type="submit" class="btn btn-default" value="Sign in"/></center>
                </form>  				
